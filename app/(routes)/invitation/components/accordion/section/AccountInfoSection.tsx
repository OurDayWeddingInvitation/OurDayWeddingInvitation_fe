    ...
    <div>
      <div className={fieldGroup}>
        <div className={fieldStyle}>
          ...
          <input type="text" placeholder="" className={`${inputStyle} max-w-[275px]`} defaultValue={title} />
        </div>
        <div className={`${fieldStyle} pb-6`}>
          <div className={labelStyle}>소개글</div>
          <textarea className={`${inputStyle} h-[104px] resize-none max-w-[275px]`} defaultValue={content} />
        </div>
            ...
            <div key={idx} className="pb-4">
              ...
              <div className="flex flex-col gap-2">
                <div className={fieldStyle}>
                  ...
                  <input type="text" className={`${inputStyle} max-w-[150px]`} placeholder="예금주명" />
                </div>
                <div className={fieldStyle}>
                  <div className={`${labelStyle} pl-[35px]`}>계좌정보</div>
                  <div className="flex flex-1 gap-2.5">
                    <input type="text" className={`${inputStyle} max-w-[150px]`} placeholder="은행" />
                    <input type="text" className={`${inputStyle} max-w-[407px]`} placeholder="계좌번호" />
                  </div>
                </div>
              </div>
